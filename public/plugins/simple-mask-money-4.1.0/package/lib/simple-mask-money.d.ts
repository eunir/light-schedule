...
declare const SimpleMaskMoney: {
    setMask: typeof setMask;
    removeMask: typeof removeMask;
    formatToNumber: typeof formatToNumber;
    createInstanceOf: typeof createInstanceOf;
    formatToCurrency: typeof formatToCurrency;
};
